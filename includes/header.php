...
<body>
<nav class="navbar navbar-expand-lg bg-brand-dark navbar-dark sticky-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto">
        ...
        <?php if (is_logged_in()): ?>
          ...
          <?php else: ?>
            <li class="nav-item">
              <a class="nav-link <?= $current === 'profile.php' ? 'active' : '' ?> d-flex flex-column align-items-center py-1" href="<?= htmlspecialchars(url('profile.php')) ?>" title="Perfil">
                <i class="bi bi-person-circle fs-5"></i>
                <small class="lh-1"><?= htmlspecialchars($_SESSION['user']['name']) ?></small>
              </a>
            </li>
          <?php endif; ?>
